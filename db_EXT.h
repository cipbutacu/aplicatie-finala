...
#define MYSQL_DB 			"DetaliiSemne"
#define MYSQL_TABLE_NAME	"Capturi"
...
typedef struct
{
	char denumire_obiect[256];
	char latitudine[20];
	char longitudine[20];
}BufferDB;

extern BufferDB Buffer_DB;
extern uint8_t flag_notify_db_update;
extern pthread_mutex_t SemaforeDB_exit_flag ;
extern uint8_t flag_req_to_stop_Thread;
extern pthread_mutex_t Semafore_exit_flag;
/*EXTERN VARIABLES*/
